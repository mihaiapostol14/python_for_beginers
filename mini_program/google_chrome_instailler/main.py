...
def main():
    """
    The main function creates an instance of the GgoogleChromeInstailler class
    with the URL of the Google Chrome official website.
    """
    return GgoogleChromeInstailler(url='https://www.google.com/intl/ru_ru/chrome/')
